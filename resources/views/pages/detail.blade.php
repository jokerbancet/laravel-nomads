                    ...
                    <div class="row">
                                ...
                                <div class="gallery">
                                    ...
                                    <div class="xzoom-thumbs">
                                        <a href="frontend/images/pic_featured.jpg">
                                            <img src="frontend/images/pic_featured.jpg" class="xzoom-gallery" width="128" xpreview="frontend/images/pic_featured.jpg">
                                        </a>
                                        <a href="frontend/images/pic_featured.jpg">
                                            <img src="frontend/images/pic_featured.jpg" class="xzoom-gallery" width="128" xpreview="frontend/images/pic_featured.jpg">
                                        </a>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-details card-right">
                                ...
                                <table class="trip-informations">
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" class="text-right">4 Day 3 Nights</td>
                                    </tr>
                                    <tr>
                                        <th width="50%">Type</th>
                            ...
                            <div class="join-container">
                                <a href="{{ route('checkout') }}" class="btn btn-block btn-join-now mt-3 my-2">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
